...
class EnhancedAccessSystem {
    constructor() {
        ...
        this.appleSignInButton = document.getElementById('apple-sign-in');
    ...
    addEventListeners() {
        ...
        this.appleSignInButton.addEventListener('click', this.handleAppleSignIn.bind(this));
    ...
    async handleAppleSignIn() {
        try {
            ...
            if (error.code === 'auth/operation-not-allowed') {
                this.showMessage('Apple Sign-In is not enabled. Please contact the administrator.', 'error');
                console.error('Apple Sign-In is not enabled in Firebase console.');
            } else {
                this.showMessage('Apple Sign-in failed. Please try again or use another method.', 'error');
            }
        }
    }
